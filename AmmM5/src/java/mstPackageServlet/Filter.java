    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(key != null){
            ...
            if(key.equals("q")){
                ...
                ArrayList<Oggetti_Vendita> lista;
                
                if(!request.getParameter("valore").equals("")){
                        lista = Oggetti_Vendita_Factory.getInstance().getSearchedItem(request.getParameter("valore"));
                }
                else{
                    lista =  Oggetti_Vendita_Factory.getInstance().getListaOggetti();
                }
                ...
                response.setHeader("Cache-Control", "no-store, no-cache, "
                                + "must-revalidate");
                request.getRequestDispatcher("jsonList.jsp").forward(request, response);
            }
        }
