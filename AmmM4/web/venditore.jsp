...
<!-- JSP PAGINA PRINCIPALE VENDITORE -->
    ...
    <body>
        ...
        <div class="page">
            ...
            <div class="content">
                ...
                <div id="contenitore-tabella-venditore">
                    <%@include file="tabellaVenditore.jsp" %>
                </div>
                
                <div id="contenitore-contenuto-vendite">
                    <h2>Vendi un articolo:</h2>
                        <form method="get" action="venditaOggetto.html" id="form-vendita">
